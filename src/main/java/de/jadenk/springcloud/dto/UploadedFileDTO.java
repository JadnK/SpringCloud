...
public class UploadedFileDTO {
    ...
    private String fileDataBase64;          // Base64-kodierte Datei-Daten
    ...
    public UploadedFileDTO(UploadedFile file) {
        ...
        if (file.getAuthorizedUsers() != null) {
            this.authorizedUserIds = file.getAuthorizedUsers()
                    .stream().map(u -> u.getId()).collect(Collectors.toList());

            this.authorizedUsernames = file.getAuthorizedUsers()
                    .stream().map(u -> u.getUsername()).collect(Collectors.toList());
        }
    }

    // Nur Getter – immutables DTO
    public Long getId() { return id; }
    public String getFileName() { return fileName; }
    public String getFileType() { return fileType; }
    public String getFileDataBase64() { return fileDataBase64; }
    public LocalDateTime getUploadTime() { return uploadTime; }
    public Long getFileOwnerId() { return fileOwnerId; }
    public String getFileOwnerUsername() { return fileOwnerUsername; }
    public List<Long> getAuthorizedUserIds() { return authorizedUserIds; }
    public List<String> getAuthorizedUsernames() { return authorizedUsernames; }
}
